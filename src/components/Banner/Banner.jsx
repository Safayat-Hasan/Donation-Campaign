...
const Banner = () => {
    return (
        <div className="">
            <img className="banner-image" src="/Resources/donation.png" alt="" />
            
            <div className="overlay"></div>

            <div className="banner-content">
                <h2 className="text-black text-5xl text-center font-bold mt-32">I Grow By Helping People In Need</h2>
